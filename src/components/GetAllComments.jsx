...
function GetAllMyComments() {
    ...
    return (
        ...
        {documents.map(d => (
              ...
              <Row style={{display:"flex",justifyContent:"center",marginTop:8,backgroundColor:"#1C9B13",borderRadius:10,boxShadow: "2px 2px 5px #999"}}>
          
            <Col   sm={6} xs={6} md={6} lg={6} xl={6} xxl={6} xxxl={6}  style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}} >
          ...
          <img onLoad={()=>setLoadImages(true)}   style={{display:"flex",width:"100%",maxHeight:"250px", maxWidth:"700px" ,height:"100%",objectFit:"cover"}} src={d.img}></img>
            ...
            <textarea
            style={{resize:"none",backgroundColor:"#167A1090",width:"100%",margin:4,marginRight:10,fontSize:10,padding:5,borderWidth:0,color:"#EEEEEE",textJustify:"inter-word",textAlign:"justify"}}
        maxLength={800}
        rows={10}
        cols={80}
        id="message"
