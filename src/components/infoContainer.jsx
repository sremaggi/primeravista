...
import { GiBed,GiRiceCooker,GiSofa,GiDesk,GiCityCar,GiRoundTable } from "react-icons/gi";
...
function InfoContainer(props) {
    ...
    return (
       ...
       <button to={"/information/bedroom"} onClick={()=>clickBedRoom(!bedroom)} style={{textDecoration:"none", color:"green",width:"100%",border:"none", backgroundColor:"#F3F3F3",marginTop:5}}>
       <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       ...
       <button onClick={()=>clickBathRoom(!bathroom)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
       <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
       ...
       <Container>
       <Row style={{display:"flex", backgroundColor:"#454545",color:"white",justifyContent:"center",marginTop:2,padding:7,fontSize:15}}>
        Espacio común
       </Row>
       </Container>
      <button onClick={()=>clickKitchen(!kitchen)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
      <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
      ...
      <button onClick={()=>clickBedRoom2(!bedroom2)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
      <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
      ...
      <button onClick={()=>clickLiving(!living)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
      <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
      ...
      <button onClick={()=>clickDinnerRoom(!dinnerRoom)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
      <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
      ...
      <button onClick={()=>clickDestkop(!desktop)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
      <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
      ...
      <Container>
       ...
       <button onClick={()=>clickParking(!parking)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
      <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
      ...
      <button onClick={()=>clickUpGarden(!upGarden)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
      <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
      ...
      <button onClick={()=>clickDownGarden(!downGarden)} style={{textDecoration:"none", color:"green",width:"100%", backgroundColor:"#F3F3F3",border:"none"}}>
      <Row style={{display:"flex",justifyContent:"center",marginTop:3,padding:10,fontSize:15}}>
       <Col style={{display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center"}}>
