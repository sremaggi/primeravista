        ...
        return (
            ...
            <div style={{display:"flex",marginTop:4,borderRadius:100}}>
                ...
                <div>
                    ...
                    <div>
                        <img height={450}  style={{borderRadius:5}} src="https://firebasestorage.googleapis.com/v0/b/primeravista-50b01.appspot.com/o/assests%2FhomeImages%2FIMG-1582.jpg?alt=media&token=d2d406c2-87d1-4a15-96f9-36a5ea777710" alt="" />
                        <p style={{backgroundColor:"green"}}  className="legend">Balcón</p>
                    </div>
                    <div>
                        <img height={450}  style={{borderRadius:5}} src="https://firebasestorage.googleapis.com/v0/b/primeravista-50b01.appspot.com/o/assests%2FhomeImages%2FIMG-1441.jpg?alt=media&token=884a0c86-2267-48b7-ab67-a65da9909311" alt="" />
                        <p style={{backgroundColor:"green"}}  className="legend">Oficina</p>
                    </div>
                    <div>
                        <img height={450}  style={{borderRadius:5}}  src="https://firebasestorage.googleapis.com/v0/b/primeravista-50b01.appspot.com/o/assests%2FhomeImages%2FIMG-1439.jpg?alt=media&token=f6cb3b21-fff2-42d4-b906-a37247c9798c" alt="" />
                        <p style={{backgroundColor:"green"}}  className="legend">Interior</p>
                    </div>
                    <div>
                        <img height={450}  style={{borderRadius:5}} src="https://firebasestorage.googleapis.com/v0/b/primeravista-50b01.appspot.com/o/assests%2FhomeImages%2FIMG-1433.jpg?alt=media&token=acfffdd3-61b8-44da-93aa-1e62ab3e17ec" alt="" />
                        <p style={{backgroundColor:"green"}}  className="legend">Cocina</p>
                    </div>
                    <div>
                        <img height={450}  style={{borderRadius:5}}  src="https://firebasestorage.googleapis.com/v0/b/primeravista-50b01.appspot.com/o/assests%2FhomeImages%2FIMG-1621.jpg?alt=media&token=1e6efb0f-7e91-41d5-ad26-2c64f51fbd68" alt="" />
